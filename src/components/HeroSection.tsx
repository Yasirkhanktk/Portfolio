    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 relative z-10 text-center">
        <div className={`space-y-12 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
          {/* Status badge */}
          <div className="inline-flex items-center gap-3 p-4 rounded-3xl glass-morphism border border-primary/30 mb-12">
            <div className="w-3 h-3 bg-green-400 rounded-full animate-pulse" />
            <span className="text-primary font-medium">Available for exciting projects</span>
          </div>
          
          {/* Hero content with visual emphasis */}
          <div className="space-y-12">
            {/* Creative visual element */}
            <div className="relative">
              <div className="absolute inset-0 flex items-center justify-center opacity-20">
                <div className="w-80 h-80 border-2 border-primary/30 rounded-full animate-pulse" />
              </div>
              <div className="absolute inset-0 flex items-center justify-center opacity-10">
                <div className="w-96 h-96 border border-primary/20 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
              </div>
              
              {/* Main heading */}
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-tight relative z-10">
                <span className="block text-foreground mb-4">Design.</span>
                <span className="block gradient-text mb-4">Create.</span>
                <span className="block text-foreground/80">Inspire.</span>
              </h1>
            </div>
          ...
          {/* Action buttons with visual enhancement */}
          <div className="flex flex-col sm:flex-row gap-8 justify-center items-center pt-12">
            <button
              onClick={scrollToPortfolio}
              className="group relative bg-gradient-to-r from-primary to-cyan-400 text-white px-12 py-6 rounded-full font-medium overflow-hidden transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:shadow-primary/40 transform"
            >
            ...
            <button 
              ...
              className="group glass-morphism border-2 border-primary/50 text-foreground px-12 py-6 rounded-full font-medium hover:border-primary hover:bg-primary/20 transition-all duration-500 hover:scale-110 backdrop-blur-xl"
            >
        ...
        {/* Enhanced scroll indicator with creative elements */}
        <div className="flex flex-col items-center mt-24 space-y-4">
          <div className="text-sm text-muted-foreground">Discover More</div>
          <div className="animate-bounce pulse-glow p-4 rounded-full glass-morphism border border-primary/40 hover:border-primary/60 transition-all duration-300 group cursor-pointer">
